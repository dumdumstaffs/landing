...
sensors.init({
	server_url: 'https://data.momodata123.com/sa?project=Moneta',
...
sensors.registerPage({
	...
	current_activity_name:GetUrl('ls') || getCookie('ls')
});
...
let languageList = ['/en-au/','/hant/','/th/','/ms/','/de/','/es/','/hans/','/it/','/fr/','/pt/','/sv/','/vi/','/id/','/ko/','/mn/','/kk/','/ru/','/en/','/pl/','/et/','/ar/','/zh-au/','/en-za/','/tl/','/pl-pl/']
...
jQuery(document).ready(function ($) {
	...
	$('.a2a_button_facebook_messenger').click(function(){
		let shareValue = {
			"current_page_name" : window.location.pathname.replace(urlRegex, '/'),
