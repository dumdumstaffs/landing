...
;function Yc(a){var b=Uc(String(y.location.href)),c;(c=y.__SAPISID||y.__APISID||y.__OVERRIDE_SID)?c=!0:(c=new vc(document),c=c.get("SAPISID")||c.get("APISID")||c.get("__Secure-3PAPISID")||c.get("SID"),c=!!c);if(c&&(c=(b=0==b.indexOf("mSWAPbxGjN0.html")||0==b.indexOf("chrome-extension:"))?y.__SAPISID:y.__APISID,c||(c=new vc(document),c=c.get(b?"SAPISID":"APISID")||c.get("__Secure-3PAPISID")),c)){b=b?"SAPISIDHASH":"APISIDHASH";var d=String(y.location.href);return d&&c&&b?[b,Wc(Uc(d),c,a||null)].join(" "):null}return null}
...
A("yt_logging_screen.setCurrentScreen",oi,void 0);function pi(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=R("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=R("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=J(window.location.href);g&&f.push(g);g=J(d);if(0<=Za(f,g)||!g&&0==d.lastIndexOf("../index-2.html",0))if(T("autoescape_tempdata_url")&&(f=document.createElement("a"),Sb(f,d),d=f.href),d){g=d.match(Xb);d=g[5];f=g[6];g=g[7];var k="";d&&(k+=d);f&&(k+="?"+f);g&&(k+="#"+g);d=k;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||b.ved)&&
...
;A("yt.setConfig",Q,void 0);A("yt.config.html",Q,void 0);A("yt.setMsg",Fh,void 0);A("yt.msgs.html",Fh,void 0);A("yt.logging.errors.log",Dh,void 0);
