...
if (null !== mainNav) {
  ...
  null !== a &&
    a.children.length > 0 &&
    (r = `<a href="${a.children[0].href}" class="uk-button uk-button-primary uk-border-rounded uk-align-center">${a.children[0].innerText}<i class="fas fa-sign-in-alt uk-margin-small-left"></i></a>`);
