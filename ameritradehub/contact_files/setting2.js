...
function calcNew(perc) 
{
	...
	*/
	...
	if( jQuery(".nav.nav-tabs li.active").length )
	{
		...
		if( perc == 125 )
		{
			if( money >=25 && money <= 500 ) { profit_percentage = 103; plan = "plan1"; }
		...
		{
			if( money >=25 && money <= 500 ) { profit_percentage = 115; plan = "plan1"; }
		...
		{
			if( money >=25 && money <= 500 ) { profit_percentage = 130;  plan = "plan1"; }
		...
		{
			if( money >=25 && money <= 500 ) { profit_percentage = 150; plan = "plan1"; }	 
